...
network:: network(const ServerConfigs &server_config) : _server_config(server_config)
{
...
network:: network(const ServerConfigs &server_config , bool is_server) : _is_server(is_server), _server_config(server_config)
{
